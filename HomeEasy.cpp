/**
* HomeEasy Library, to control the NEXA smart outlet. HomeEasy happens to use the same protocol as Nexa
*
* Usage notes : 
...
*     There is a degree of configurability for the transmission pin.  We use PORTB, so you must choose a pin on that PORT (PB*) from http://www.arduino.cc/en/Hacking/Pin Mapping168
